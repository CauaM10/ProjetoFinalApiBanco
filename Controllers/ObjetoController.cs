...
namespace ProjetoFinalApi.Controllers
{
    public class ObjetoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ObjetoId,ObjetoNome,ObjetoCor,ObjetoObservacao,ObjetoLocalDesaparecimeto,ObjetoFoto,ObjetoDtDesaparecimeto,ObjetoDtEncontro,ObjetoStatus,UsuarioId")] Objeto objeto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ObjetoId,ObjetoNome,ObjetoCor,ObjetoObservacao,ObjetoLocalDesaparecimeto,ObjetoFoto,ObjetoDtDesaparecimeto,ObjetoDtEncontro,ObjetoStatus,UsuarioId")] Objeto objeto)
        {
